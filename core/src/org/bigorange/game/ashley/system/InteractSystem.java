...
import org.bigorange.game.ashley.component.ActionableComponent;
import org.bigorange.game.ashley.component.InteractComponent;
    ...
    private void doEntityAction(Entity player, Entity interactEntity) {
        ...
        switch (actionTypeCmp.type) {
            case TALK -> {
                ...
                MessageManager.getInstance().dispatchMessage(0.0f, this, MessageType.MSG_PLAYER_TALK_TO_NPC, "Talk..");
            }
            case UNDEFINED -> {
            }
        }
