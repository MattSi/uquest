...
public class UIAdapterExample extends InputAdapter implements ApplicationListener {
    ...
    public void create() {
        ...
        pb_green = new ProgressBar(0, 1, 0.001f, false, skin, "green_h");
        pb_yellow = new ProgressBar(0, 1, 0.001f, false, skin, "yellow_h");
        pb_red = new ProgressBar(0, 1, 0.001f, false, skin, "red_h");
        pb_blue = new ProgressBar(0, 1, 0.001f, false, skin, "blue_h");
        // window.debug();
        Window window = new Window("Dialog", skin);
        //window.getTitleTable().add(new TextButton("X", skin)).height(window.getPadTop());
        window.getTitleTable().add(new ImageButton(skin,"icon_close" )).height(window.getPadTop());
        ...
        window.row();
        window.add(pb_green).expandX().fillX();
        window.row();
        window.add(pb_red).expandX().fillX();
        window.row();
        window.add(pb_blue).expandX().fillX();
        window.row();
        window.add(pb_yellow).expandX().fillX();
        window.row();
    ...
    public void render() {
        ...
        float value = pb_green.getValue();
        if(value < 1f){
            value += 0.001f;
            pb_green.setValue(value);
            pb_blue.setValue(value);
            pb_red.setValue(value);
            pb_yellow.setValue(value);
        }
